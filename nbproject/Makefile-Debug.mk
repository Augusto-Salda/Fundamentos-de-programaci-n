...
${OBJECTDIR}/Funcion\ de\ repeticion\ while.o: Funcion\ de\ repeticion\ while.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Funcion\ de\ repeticion\ while.o Funcion\ de\ repeticion\ while.c
...
${OBJECTDIR}/Problemas\ con\ secuencia\ de\ control.o: Problemas\ con\ secuencia\ de\ control.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Problemas\ con\ secuencia\ de\ control.o Problemas\ con\ secuencia\ de\ control.c
